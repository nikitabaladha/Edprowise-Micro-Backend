...
router.get("/get-all-data", roleBasedMiddleware("Admin", "School"), getall);

router.post("/create-tab", roleBasedMiddleware("Admin", "School"), createtab);
...
//-----------------------------------------------------TC Data--------------------------------------//
router.get("/get-all-data-tc", roleBasedMiddleware("Admin", "School"), TCData);
