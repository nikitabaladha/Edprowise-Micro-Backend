import ExamFeePayment from "../../../../models/FeesModule/BoardExamFeePayment.js";
import { BoardExamFeePaymentValidator } from "../../../../validators/FeesModule/BoardExamFeePaymentValidator.js";
  ...
  try {
    ...
    if (!schoolId) {
      return res.status(401).json({
        hasError: true,
        message: "Access denied: You do not have permission to submit exam fees.",
      });
    }
