...
export async function updateById(req, res) {
  ...
  const { error } = JournalValidator.JournalValidatorUpdate.validate(req.body);
  if (error) {
  ...
  const { entryDate, documentDate, narration, itemDetails, status } = req.body;
