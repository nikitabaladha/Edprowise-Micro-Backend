...
//     // 2. TDS/TCS Ledger (Credit)

//     // if TDS then store TDSTCSRateWithAmountBeforeGST at debit side
//     // if TCS then store TDSTCSRateWithAmountBeforeGST at  credit side
...
//       tdsLedgerId = tdsLedgerToUpdate._id.toString();
//       await updateOpeningClosingBalance(
//         schoolId,
//         academicYear,
//         tdsLedgerId,
...
//       );
//       ledgerIdsToUpdate.add(tdsLedgerId);
//     }

//     // 3. Payment Mode Ledger (Credit)

//     // if TDS then paymentAmount will be  subTotalAmountAfterGST- TDSTCSRateWithAmountBeforeGST
//     // if TCS then paymentAmount will be  subTotalAmountAfterGST+ TDSTCSRateWithAmountBeforeGST
//     // if TCS then paymentAmount will be  subTotalAmountAfterGST
