...
async function getAllJournalWIthoutBankCashBySchoolId(req, res) {
  try {
    ...
    for (const entry of JournalEntries) {
      ...
      const hasBankOrCash = itemsWithLedgerNames.some(
        (item) =>
          item.groupLedgerName === "Bank" || item.groupLedgerName === "Cash"
      );
...
export default getAllJournalWIthoutBankCashBySchoolId;
