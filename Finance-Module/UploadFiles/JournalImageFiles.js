...
const documentFileDir = "./Documents/FinanceModule/DocumentImageForJournal";
const documentImageDir = "./Images/FinanceModule/DocumentImageForJournal";

[documentFileDir, documentImageDir].forEach((dir) => {
  ...
  storage: multer.diskStorage({
    destination: (req, file, cb) => {
      ...
      if (file.fieldname === "documentImage") {
        cb(null, isPdf ? documentFileDir : documentImageDir);
      } else {
